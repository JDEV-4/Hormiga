...
namespace Interface
{
    ...
    {
        Task<Usuario> Registrar(string nombreCompleto, string correo, string telefono, string password, int rolId);
  ...
  Task<IEnumerable<UsuarioBasicoDTO>> GetBasicAllAsync(); 
